...
?>
        ...
        <h3 class="twitter-widget"><?php echo $instance['widget_title']; ?></h3>
        ...
        <!-- end twitter widget -->
		<a class="twitter-action" href="http://twitter.com/<?php echo $instance['screen_name']; ?>"><?php _e('Follow on Twitter! ', 'site5framework') ?> &raquo; </a>
